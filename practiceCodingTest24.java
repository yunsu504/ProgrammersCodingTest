...
public class practiceCodingTest24 {
	...
	class Solution {
	    public boolean solution(int x) {
			...
			for (int i = 0; i < xx.length(); i++){
				int xxx = Character.getNumericValue(xx.charAt(i));
				num += xxx;
			}
			if (x % num == 0){
				answer = true;
...
테스트 9 〉	통과 (0.07ms, 51.9MB)
테스트 10 〉	통과 (0.06ms, 51.8MB)
테스트 11 〉	통과 (0.05ms, 52.7MB)
테스트 12 〉	통과 (0.05ms, 53.1MB)
테스트 13 〉	통과 (0.06ms, 52.5MB)
테스트 14 〉	통과 (0.03ms, 53.5MB)
테스트 15 〉	통과 (0.06ms, 52.3MB)
테스트 16 〉	통과 (0.05ms, 52.1MB)
테스트 17 〉	통과 (0.07ms, 52.7MB)
채점 결과
정확성: 100.0
합계: 100.0 / 100.0*/
}
